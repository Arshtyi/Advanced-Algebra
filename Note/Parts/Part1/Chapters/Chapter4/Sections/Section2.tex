...
\subsection{运算}
\dfn{线性映射全体}{线性映射全体}{
    设$V_{\mathbb{K}}$、$U_{\mathbb{K}}$，记$\mathcal{L} \left(V,U\right)$为$V \longrightarrow U$的线性映射全体.
}
\dfn{线性映射的加法与数乘}{线性映射的加法与数乘}{
    ...
    \]
    容易验证二者均是线性映射且
    $\bm{\varphi}+\bm{\psi} \in \mathcal{L}\left(V,U\right)$，$k\bm{\varphi}
        \in \mathcal{L} \left(V,U\right)$.
}
\thm{}{线性映射全体是线性空间}{
    $\mathcal{L} \left(V,U\right)$在\cref{def:线性映射的加法与数乘}的加法和数乘运算下是$\mathbb{K}$上的线性空间.
...
\exa{}{}{
    ...
    $V = C\left[0,1\right]/
        \mathbb{R}$是$\mathbb{R}$上的代数.乘法定义为
    \[
...
\exa{}{}{
    \cref{def:线性映射全体}提到$\mathcal{L} \left(V_{\mathbb{K}}
