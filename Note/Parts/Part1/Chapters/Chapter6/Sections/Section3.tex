...
\cor{几何意义的Cayley-Hamilton定理}{几何意义的Cayley-Hamilton定理}{
    设$\bm{\varphi}\in \call  \left(V_{\mathbb{K}}^n\right)$，其特征多项式$f\left(\lambda\right)=\left|
