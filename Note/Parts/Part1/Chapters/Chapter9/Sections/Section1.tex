...
\pro{$\bbr^3$中向量点积的性质}{R^3中向量点积的性质}{
    设$\bm{u},\bm{v},\bm{w}\in\mathbb{R}^3,c\in\mathbb{R}$，则\begin{enumerate}[label=\arabic*）]
...
\dfn{实内积空间}{实内积空间}{
    ...
    \end{align*}且满足（$\bm{\alpha},\bm{\beta},\bm{\gamma}\in V,c\in\mathbb{R}$）\begin{enumerate}[label=\arabic*）]
...
\exa{}{}{
    ...
    设$V=\mathbb{R}_n,\bm{\alpha}=\left(
        ...
        \right)$，定义内积\[\left(
        \bm{\alpha},\bm{\beta}
        \right)\coloneqq \bm{\alpha}\bm{\beta}'=x_1y_1+x_2y_2+\cdots+x_ny_n\]称为$\mathbb{R}_n$上的标准内积.
    ...
    设$V=\mathbb{C}_n,\bm{\alpha}=\left(
        ...
        \right)$，定义内积\[\left(
        \bm{\alpha},\bm{\beta}
        \right)\coloneqq \bm{\alpha}\overline{\bm{\beta}}'=x_1\overline{y_1}+x_2\overline{y_2}+\cdots+x_n\overline{y_n}\]称为$\mathbb{C}_n$上的标准内积.
}
\exa{}{}{
...
\exa{}{}{
    ...
    设$V=\mathbb{C}^n,\bm{\alpha},\bm{\beta}\in V,\bm{H}$是$n$阶正定Hermite阵，定义\[
        \left(
        \bm{\alpha},\bm{\beta}
        \right)\coloneqq \bm{\alpha}'\bm{G}\overline{\bm{\beta}}
    \]这称为$\mathbb{C}^n$上相伴于正定Hermite阵$\bm{H}$的内积.

    设$V=\mathbb{C}_n,\bm{\alpha},\bm{\beta}\in V,\bm{H}$是$n$阶正定Hermite阵，定义\[
        \left(
        \bm{\alpha},\bm{\beta}
        \right)\coloneqq \bm{\alpha}\bm{G}\overline{\bm{\beta}}'
    \]这称为$\mathbb{C}_n$上相伴于正定Hermite阵$\bm{H}$的内积.
}
\exa{}{}{
...
\exa{}{}{
    设$V=\mathbb{R}^n$，取标准内积，于是Cauchy-Schwarz不等式推得Cauchy不等式\[
        \left(
