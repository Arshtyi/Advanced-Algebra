...
\cor{}{特征值在域中则矩阵的约当标准型也在域中}{
    设$\bm{A}\in M_n\left(\mathbb{K}\right)$的特征值全在$\mathbb{K}$中，则$\bm{A}$在$\mathbb{K}$上相似于其Jordan标准型.\begin{proof}
        首先，$\bm{A}$必定复相似于\[
            \bm{J}= \mathrm{diag}\left\{
            \bm{J}_{r_1}\left(\lambda_1\right),\bm{J}_{r_2}\left(\lambda_2\right),\cdots,\bm{J}_{r_k}\left(\lambda_k\right)
            \right\}
...
\rem{}{}{
    根据\cref{lem:幂的像空间与核空间}，特征值$\lambda_1$的特征子空间$V_{\lambda_1}=\mathrm{Ker}\left(\bm{\varphi}-\lambda_1\bm{I}_V\right)\subseteq R\left(\lambda_1\right).$
}
\cor{}{}{
...
\thm{全空间关于Jordan标准型的两种直和分解}{全空间关于Jordan标准型的两种直和分解}{
    设$\bm{\varphi}\in \mathcal{L}\left(V_{\mathbb{C}}^n\right)$\begin{enumerate}[label=\arabic*）]
...
\exa{}{}{
    设$\bm{A}\in M_n\left(\mathbb{C}\right)$，证明：$\bm{A}=\bm{BC},$其中$\bm{B},\bm{C}$为对称阵.\begin{proof}
        因为存在非异阵$\bm{P}$使得\[
...
\exa{}{}{
    设$\bm{A}\in M_n\left(\mathbb{C}\right)$，求$\bm{A}^k\left(k\geqslant 1\right).$\begin{solution}
        因为存在非异阵$\bm{P}$使得\[
            \bm{P}^{-1}\bm{A}\bm{P}=\bm{J}=
            \mathrm{diag}\left\{
            \bm{J}_{r_1}\left(\lambda_1\right),\bm{J}_{r_2}\left(\lambda_2\right),\cdots,\bm{J}_{r_k}\left(\lambda_k\right)
...
\lem{同时对角化}{同时对角化}{
    设$\bm{A},\bm{B}\in M_n\left(\mathbb{C}\right)$，若$\bm{A},\bm{B}$均可对角化且乘积可交换即$\bm{AB}=\bm{BA}$，则$\bm{A},\bm{B}$可同时对角化即存在非异阵$\bm{P}$使得$\bm{P}^{-1}\bm{AP}$和$\bm{P}^{-1}\bm{BP}$均为对角阵.\begin{proof}
...
\thm{Jordan-Chevalley分解定理}{Jordan-Chevalley分解定理}{
    设$\bm{A}\in M_n\left(\mathbb{C}\right),$则$\bm{A}$一定可以作分解$\bm{A}=\bm{B}+\bm{C}$,其中\begin{enumerate}[label=（\arabic*）]
        \item $\bm{B}$可对角化
        \item $\bm{C}$是幂零阵
...
\exa{}{}{
    设矩阵\[
        ...
        \end{pmatrix}
    \]求其Jordan标准型.\begin{solution}
        明显特征值为$1$，代数重数$4$，几何重数\begin{align*}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              & 4-\mathrm{rank}\left(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \bm{A}-\bm{I}_4
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \right)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \\
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          = & \begin{cases*}
...
\thm{唯一确定可交换的线性变换}{唯一确定可交换的线性变换}{
    ...
    $则\begin{enumerate}[label=\arabic*）]
        ...
        \item $\exists g\left(x\right)\in\mathbb{K}\left[x\right]\st\bm{\psi}=g\left(\bm{\varphi}\right)$
    \end{enumerate}\begin{proof}
        因为$V=C\left(
            \bm{\varphi},\bm{\alpha}
            \right)$的基为$\left\{
