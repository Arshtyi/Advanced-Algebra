    ...
    \end{enumerate}\begin{proof}
        \begin{enumerate}[label=\arabic*)]
            \item 令$f\left(\lambda\right)=
                  ...
                  $是关于$\lambda$的多项式.$\forall a\in \bbk $,$f\left(a\right)=0\Longrightarrow f\left(\lambda\right)=0.$
            \item 令$\left(f_{ij}\left(\lambda\right)\right)_{n\times n}=
                      ...
                      \right|\bm{I}_n
                  $其中$f_{ij}\left(\lambda\right)\in \bbk \left[\lambda\right]$.$\forall a\in \bbk ,
...
\thm{特征矩阵的法式}{特征矩阵的法式}{
    设$\bm{A}\in M_n\left(\bbk \right)$,则$\lambda\bm{I}_n-\bm{A}$相抵于
    \[
        \diag \left\{
