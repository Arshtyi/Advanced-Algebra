...
\exa{}{}{
    ...
    \]
    容易证明$C\left[0,1\right]$是$\bbr$的线性空间.
}
\exa{}{}{
    $M_{m \times n}\left(
        \bbk
        \right)$为$\bbk$上所有$m
        \times n$矩阵全体，其在矩阵的加法和数乘下是$\bbk$上的线性空间.
    特别地，$M_{n}\left(\bbk\right)$还是一个$\bbk$-代数（\cref{def:代数}）.
}
\exa{}{}{
    任意的$\bbk_1 \subseteq
        \bbk_2$,均有$\bbk_2$
...
\pro{线性空间的基本性质}{线性空间的基本性质}{
    设$\bbk$上的线性空间$V$，$\forall \bm{\alpha},
        \bm{\beta},\bm{\gamma}
