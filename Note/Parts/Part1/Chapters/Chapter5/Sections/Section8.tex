...
\]
（其中$a\in\mathbb{K}$称为系数，$i_1,i_2,\cdots,i_n\in\mathbb{N}$）称为一个单项式.
...
\end{align*} 相等当且仅当$a_{i_1i_2\cdots i_n}=b_{i_1i_2\cdots i_n},\forall \left(i_1,i_2,\cdots,i_n\right)\in\mathbb{N}^n$.
}
\dfn{多元多项式全体}{多元多项式全体}{
