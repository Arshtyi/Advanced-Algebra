...
\subsection{定义}
\dfn{整除}{整除}{
    设$f\left(x\right),g\left(x\right)\in \bbk \left[x\right]$,若存在$h\left(x\right)\in \bbk \left[x\right]$,\st
    \[
...
\pro{整除的若干性质}{整除的若干性质}{
    设$f\left(x\right),g\left(x\right),h\left(x\right)\in \bbk \left[x\right]$,$c\neq 0\in\bbk $,则\begin{enumerate}[label=\arabic*)]
        ...
        \item 若$f\left(x\right)\mid g\left(x\right),f\left(x\right)\mid h\left(x\right)$,则$\forall u\left(x\right),v\left(x\right)\in \bbk \left[x\right]$,\st
              \[
                  f\left(x\right)\mid g\left(x\right)u\left(x\right)+h\left(x\right)v\left(x\right)
              \]
        \item 若$f\left(x\right)\mid g\left(x\right)$且$g\left(x\right)\mid f\left(x\right)$,则$\exists k\in\bbk $,\st\[
...
\subsection{带余除法}
\thm{带余除法}{带余除法}{
    设多项式$f\left(x\right),g\left(x\right)\in \bbk \left[x\right],g\left(x\right)\neq 0$,则必定存在唯一的$q\left(x\right),r\left(x\right)\in \bbk \left[x\right]$,\st
    \[
