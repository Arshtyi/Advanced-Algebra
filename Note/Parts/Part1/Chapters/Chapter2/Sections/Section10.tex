...
若$\bm{A} = \diag \left\{\bm{A}_1,\cdots,\bm{A}_k\right\}$可逆则
\[
    \bm{A}^{-1} =
    \diag \left\{
...
\exa{}{temp1}{
    ...
    \[
        ...
        \end{vmatrix}=\left|
        \bm{A}+\rmi \bm{B}
        \right|\left|\bm{A}-\rmi \bm{B}\right|
    \]
    \begin{proof}
        \begin{align*}
            \begin{vmatrix}
            ...
            \end{vmatrix}     \\
             & =\begin{vmatrix}
                ...
                \end{vmatrix} \\
             & =
            \left|\bm{A}+\rmi \bm{B}\right|
            \left|\bm{A}-\rmi \bm{B}\right|\qedhere
        \end{align*}
    \end{proof}
}
\exa{}{}{
