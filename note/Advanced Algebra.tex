...
本文完全使用\LaTeX 写作,所有的\LaTeX 源代码可在Github上作者的仓库找到并下载,项目地址：https://github.com/Arshtyi/Advanced-Algebra ,包括配套的习题解答也可以在此找到,允许个人预习、复习等其他个人用途或转载但禁止未经作者本人同意的商业相关用途.
\begin{flushright}
    \begin{tabular}{c}
        机笑/Arshtyi\\
        \today \\ 穷诸
